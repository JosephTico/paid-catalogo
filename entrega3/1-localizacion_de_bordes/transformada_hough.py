...
def line_detection(image, edge_image, num_rhos=180, num_thetas=180, t_count=240):
  ...
  subplot3 = figure.add_subplot(1, 3, 2)
  subplot3.set_facecolor((0, 0, 0))
  subplot4 = figure.add_subplot(1, 3, 3)
